...
def read_dataset(file_path: str, split: str, access_token: str=None) -> datasets.Dataset:
    ...
    try:
        ...
        logging.exception("Error: Could not load data from file or Huggingface hub: " + file_path)
        return

    return dataset

def ds2csv(ds: datasets.Dataset, sample_dir: str, num_instructions: int=4, num_responses: int=32):
